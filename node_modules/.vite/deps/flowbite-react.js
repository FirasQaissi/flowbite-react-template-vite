...
var regexMap = [
  ...
  [new RegExp("(?<!-)(shadow)(?!-)\\b", "g"), "shadow-sm"],
...
var DrawerHeader = (0, import_react54.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime49.jsxs)("div", { ref, className, ...restProps, children: [
    ...
    (0, import_jsx_runtime49.jsxs)("button", { onClick: onClose, "data-testid": "close-drawer", className: theme2.inner.closeButton, children: [
